...
Update: Snow has been promoted into the production gate set. `npm run smoke:feel`, `npm run smoke:progression`, `npm run smoke:snow-live`, and `npm run smoke:snow-boss` now cover Snow opener tuning, Swamp -> Snow -> Ocean progression, live first-30-seconds survival, and Frost Guardian entry/attack/death.
...
This was coherent content but not promoted content yet. The first-minute opener has now been retuned to the promoted slice convention and Snow is included in deterministic smoke coverage alongside Forest, Cave, Sand, and Swamp.

## Promotion Blockers

1. Fixed 2026-06-04: Snow is included in `runHomunculiFeelSmoke()`.
...
2. Fixed 2026-06-04: Snow is included in `runHomunculiProgressionSmoke()`.
...
3. Fixed 2026-06-04: Snow has vertical-slice tuning.
...
4. Fixed 2026-06-04: Snow opener matches promoted readability constraints.
...
5. Fixed 2026-06-04: Frost Guardian death path is covered by `smoke:snow-boss`.
...
6. Fixed 2026-06-04: Frost Guardian cooldown timing is covered by `smoke:snow-boss`.
...
7. Fixed 2026-06-04: Frost Guardian raw hitbox logs were removed.
...
8. Fixed 2026-06-04: Frost Guardian phase adds use Snow-native `frost-golem`.
...
Status: completed through the named Snow live and Frost Guardian boss gates on 2026-06-04. The next promotion lane is Ocean/Sea Kings.
