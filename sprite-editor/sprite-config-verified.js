...
const SPRITE_CONFIGS = {
    ...
    forest: {
        'tree': {
            ...
            path: 'tree/tronchungo3/walking-sheet.png',  // VERIFIED: exists
            frameWidth: 48,
            frameHeight: 60,
            animations: {
        ...
        'mushroom': {
            ...
            path: 'mushroom/Run.png',  // VERIFIED: exists
            frameWidth: 150,
            frameHeight: 46,
            animations: {
        ...
        'giantfly': {
            ...
            path: 'forestlandfoes/giantflywalk4frames.png',  // VERIFIED: exists
            frameWidth: 32,
            frameHeight: 32,
            animations: {
        ...
        'squirrel': {
            ...
            path: 'forestlandfoes/squirrelwalk8frames.png',  // VERIFIED: exists
            frameWidth: 32,
            frameHeight: 32,
            animations: {
                walk: { frames: 8, rate: 10 },
        ...
        'redpanda': {
            ...
            path: 'forestlandfoes/redpandawalk8frames.png',  // VERIFIED: exists
            frameWidth: 32,
            frameHeight: 32,
            animations: {
    ...
    cave: {
        ...
        'kobold': {
            texture: 'kobold-walk',
            path: 'kobold/kobold8frames.png',  // VERIFIED: exists
            frameWidth: 148,
            frameHeight: 96,
            animations: {
                walk: { frames: 8, rate: 10 }
        ...
        'brainmole': {
            ...
            path: 'cavelandfoes/brainmole4frames.png',  // VERIFIED: exists
            frameWidth: 32,
            frameHeight: 32,
            animations: {
                walk: { frames: 4, rate: 8 },
        ...
        'intellectdevourer': {
            ...
            path: 'cavelandfoes/intellectdevourer8frames.png',  // VERIFIED: exists
            frameWidth: 32,
            frameHeight: 32,
            animations: {
                walk: { frames: 8, rate: 10 },
    ...
    desert: {
        ...
        'flyingdemon': {
            ...
            path: 'flyingdemon/flamedemon4frames.png',  // VERIFIED: exists
            frameWidth: 16,
            frameHeight: 16,
            animations: {
                walk: { frames: 4, rate: 8 }
        ...
        'skeleton-yellow': {
            ...
            path: 'skeleton/Skeleton_01_Yellow_Walk10frames.png',  // VERIFIED: exists
            frameWidth: 100,
            frameHeight: 100,
            animations: {
        ...
        'skeleton-seeker': {
            ...
            path: 'skeleton/skeleton_seeker_walk.png',  // VERIFIED: exists
            frameWidth: 100,
            frameHeight: 100,
            animations: {
                walk: { frames: 10, rate: 10 },
    ...
    castle: {
        'knight': {
            ...
            path: 'castlelandfoes/knightrun8frames.png',  // VERIFIED: exists
            frameWidth: 64,
            frameHeight: 64,
            animations: {
                walk: { frames: 8, rate: 10 }
        ...
        'rogue': {
            ...
            path: 'castlelandfoes/roguerun6frames.png',  // VERIFIED: exists
            frameWidth: 48,
            frameHeight: 48,
            animations: {
        ...
        'soldier': {
            ...
            path: 'castlelandfoes/soldier6frames.png',  // VERIFIED: exists
            frameWidth: 64,
            frameHeight: 64,
            animations: {
                walk: { frames: 6, rate: 8 }
        ...
        'squire': {
            ...
            path: 'castlelandfoes/squire8frames.png',  // VERIFIED: exists
            frameWidth: 48,
            frameHeight: 48,
            animations: {
                walk: { frames: 8, rate: 10 }
    ...
    bosses: {
        'archer-boss': {
            ...
            path: 'archerboss/boss2archerwalk8frames.png',  // VERIFIED: exists
            frameWidth: 64,
            frameHeight: 54,
            animations: {
                walk: { frames: 8, rate: 10 },
    ...
    characters: {
        'wraith': {
            texture: 'wraith-walk',
            path: 'scythewraith/scythewraithwalk8frames.png',  // VERIFIED: exists
            frameWidth: 64,
            frameHeight: 64,
            animations: {
                walk: { frames: 8, rate: 10 },
        ...
        'orb': {
            texture: 'orb-idle',
            path: 'homunculicharacters/orbidle10framesdims640x64.png',  // VERIFIED: exists
            frameWidth: 64,
            frameHeight: 64,
            animations: {
        ...
        'grim': {
            texture: 'grim-idle',
            path: 'homunculicharacters/grimidle8framesx2framesdims512x128.png',  // VERIFIED: exists
            frameWidth: 64,
            frameHeight: 64,
            animations: {
